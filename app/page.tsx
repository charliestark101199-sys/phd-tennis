    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      <nav className="mx-auto flex w-full max-w-7xl items-center justify-between px-6 py-6 lg:px-10">
        ...
        <div className="hidden items-center gap-8 md:flex">
          <a href="#about" className="text-sm font-medium text-slate-700 transition hover:text-slate-900">
            About
          </a>
          <a href="#services" className="text-sm font-medium text-slate-700 transition hover:text-slate-900">
            Services
          </a>
          <a href="#placements" className="text-sm font-medium text-slate-700 transition hover:text-slate-900">
            Placements
          </a>
      ...
      <section id="about" className="mx-auto w-full max-w-7xl px-6 pb-14 pt-8 lg:px-10 lg:pb-20 lg:pt-14">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-600">
            PHD Tennis helps ambitious student-athletes build standout recruiting profiles, connect with college
      ...
      <section id="placements" className="border-y border-slate-200 bg-white">
        <div className="mx-auto grid w-full max-w-7xl gap-6 px-6 py-10 sm:grid-cols-2 lg:grid-cols-4 lg:px-10">
          <div>
            ...
            <p className="mt-2 text-sm font-medium text-slate-600">Players placed</p>
          </div>
          <div>
            <p className="text-3xl font-bold text-slate-900">98%</p>
            <p className="mt-2 text-sm font-medium text-slate-600">Placement rate</p>
          </div>
          <div>
            <p className="text-3xl font-bold text-slate-900">150+</p>
            <p className="mt-2 text-sm font-medium text-slate-600">College programs</p>
          </div>
          <div>
      ...
      <section id="services" className="mx-auto w-full max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
        <div className="mb-10 max-w-2xl">
          ...
          <p className="mt-3 text-slate-600">
            Everything you need to stand out, stay organized, and move through recruiting with confidence.
          </p>
        </div>
          ...
          {[
            ...
            <article key={service} className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <p className="mt-3 text-sm leading-relaxed text-slate-600">
                Personalized guidance and practical tools to help you take clear, strategic next steps.
              </p>
            </article>
          ))}
        </div>
      ...
      <section id="how-it-works" className="bg-slate-900 py-16 text-white lg:py-20">
        <div className="mx-auto w-full max-w-7xl px-6 lg:px-10">
          ...
          <div className="mt-10 grid gap-5 md:grid-cols-3">
            {[
              "Build your profile",
              "Work with Pat 1-on-1",
              "Get offers and choose your school",
            ].map((step, index) => (
      ...
      <section className="mx-auto w-full max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {[
            {
              quote:
                "PHD Tennis gave us a clear plan and constant support. My daughter found a school that fits her tennis and academics perfectly.",
              author: "Parent of Division I recruit",
            },
            {
              quote:
                "The profile tools and coach outreach strategy saved me months of guesswork. I felt confident in every decision.",
              author: "Class of 2025 player",
            },
            {
              quote:
                "Pat brings elite-level experience and a genuine commitment to each athlete's long-term success.",
              author: "Greg Patton, Former Boise State Head Coach",
            },
            {
              quote:
                "From first conversation to final commitment, the process was organized, personal, and extremely effective.",
              author: "Parent of NCAA recruit",
            },
          ].map((testimonial) => (
